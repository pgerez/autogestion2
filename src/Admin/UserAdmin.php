    ...
    protected function configureFormFields(FormMapper $form): void
    {
        ...
        $form
            ->tab('User')
                ...
                ->with('Hospital', ['class' => 'col-md-6'])->end()
                ->with('Obra Social', ['class' => 'col-md-6'])->end()
        ...
        $form
            ->tab('User')
                ...
                ->end()
                ->with('Hospital')
                    ->add('hospital', null, ['label' => 'Hospital', 'help' => 'Solo para Hospitales'])
                ->end()
                ->with('Obra Social')
                    ->add('obrasocial', null, ['label' => 'Obra Social', 'help' => 'Solo para Obras Sociales'])
                ->end()
                /* ->with('Social')
